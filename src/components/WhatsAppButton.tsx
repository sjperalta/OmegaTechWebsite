...
const WhatsAppButton: React.FC = () => {
  const phoneNumber = '50499405708';
  const message = encodeURIComponent('Hola OmegaTech, me gustaría obtener más información sobre sus servicios.');
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba5a] text-white px-6 py-4 rounded-2xl shadow-2xl transition-all duration-500 hover:scale-110 active:scale-95 group-hover:shadow-[#25D366]/40">
        ...
        <span className="font-bold uppercase tracking-widest text-[10px] hidden sm:block">WhatsApp</span>
      </div>

      {/* Tooltip */}
      <div className="absolute right-0 bottom-full mb-4 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        <div className="bg-white text-black text-[10px] font-bold uppercase tracking-widest px-4 py-2 rounded-xl whitespace-nowrap shadow-xl border border-black/5 flex items-center gap-2">
