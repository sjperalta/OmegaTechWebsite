...
const Contact: React.FC = () => {
  ...
  if (status === 'success') {
    return (
      <div className="pt-24 pb-24 md:pb-32 flex items-center justify-center min-h-[60vh]">
  ...
  return (
    <div className="pt-24 pb-24 md:pb-32">
      <div className="container mx-auto px-8 max-w-6xl animate-fade-in">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="grid gap-10">
              ...
              <div className="reveal active flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-2">
                  <a href="mailto:info@omegatech.dev" className="text-on-surface-variant text-lg hover:text-primary transition-colors flex items-center gap-2">
                    <span className="material-symbols-outlined text-sm">mail</span>
                    info@omegatech.dev
                  </a>
                  <a href="tel:+50431848112" className="text-on-surface-variant text-lg hover:text-primary transition-colors flex items-center gap-2">
          ...
          <div className={`reveal active p-10 md:p-16 bg-surface-container rounded-[32px] border border-outline-variant relative transition-all duration-500 shadow-xl ${status === 'loading' ? 'opacity-70 blur-[1px]' : 'opacity-100'
            }`}>
